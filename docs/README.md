...
| [design/code-signing.md](design/code-signing.md) | Windows 代码签名（2026-09-18）：SignPath Foundation 免费开源证书的申请、面板与仓库配置、发布审批时序、元数据约定与排查 |
...
| [design/voice-input.md](design/voice-input.md) | Windows 语音输入：auto-voice 能力拆分、Worker / Server / TSF 边界、会话与重复交付语义、隐私规则和分阶段验收 |
